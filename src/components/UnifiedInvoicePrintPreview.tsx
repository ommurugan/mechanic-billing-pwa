  ...
  return <div className="fixed inset-0 bg-white z-50 overflow-auto">
      ...
      <div className="print:hidden p-4 border-b flex justify-between items-center bg-gray-50 sticky top-0">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={handlePrint} className="bg-green-600 hover:bg-green-700" size="sm">
      ...
      <div className="print-content max-w-4xl mx-auto p-8 print:p-4 print:max-w-none print:mx-0">
        ...
        {/* Vehicle Information */}
        {vehicle && <div className="bg-gray-50 print:bg-gray-100 p-4 rounded mb-6">
        ...
        {/* Items Table */}
        <InvoiceItemsTable invoiceItems={invoiceItems} invoice={invoice} loading={loading} />
        ...
        <div className="flex justify-end mb-8">
          <div className="w-full md:w-1/2 space-y-2">
            ...
            {invoice.discount_amount > 0 && <div className="flex justify-between text-green-600">
                <span>Discount:</span>
